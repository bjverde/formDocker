...
#
# This installation works with Debian 10, PHP 8.2, Drive PDO_SQLSRV 5.10.0, Microsoft ODBC Driver 17 for SQL Server , MS SQL Server 2008 R2 or higher
...
RUN pecl -vvv install sqlsrv-5.11.0
RUN pecl -vvv install pdo_sqlsrv-5.11.0
